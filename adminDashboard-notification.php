    ...
    <div class="container">
        ...
        <div class="card recent-donations" id="donation">
            ...
            if ($result_ngo->num_rows > 0) {
                ...
                while ($row2 = $result_ngo->fetch_assoc()) {
                    echo "
                        <tr>
                            
                            <td>{$row2['ngo_id']}</td>
                            <td>{$row2['feedback_text']}</td>
