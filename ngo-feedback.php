...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST["submit"])) {
        ...
        $ngoID_sql = "SELECT ngo_id FROM ngo WHERE ngo_email = '$email'";
        $ngoResult = mysqli_query($dbcon, $ngoID_sql);
        $ngoRow = mysqli_fetch_assoc($ngoResult);
        $ngo_id = $ngoRow['ngo_id'];

        $sql = "INSERT INTO ngo_feedback(ngo_id, feedback_text) VALUES ('$ngo_id', '$feedback')";
        $query = mysqli_query($dbcon, $sql);

        if ($query) {
            $msg = "✅ You feedback has been sent. Thank You NGO ✨";
        } else {
            echo "error";
        }
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-links">
            ...
            <li><a href="ngo-dashboard.php#volunteer-status"><i class="fas fa-hands-helping"></i> Volunteer Status</a>
            </li>
            <li><a href="ngo-settings.php"><i class="fas fa-cog"></i> Settings & Security</a></li>
            <li><a href="#"><i class="fas fa-star"></i> Feedback & Rating</a></li>
